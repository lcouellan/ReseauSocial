...
CREATE TABLE IF NOT EXISTS UTILISATEUR
 (
   ...
   PHOTO_PROFIL_ID BIGINT(4) NOT NULL  ,
...
CREATE  INDEX I_FK_MESSAGE_UTILISATEUR
     ON MESSAGE (UTILISATEUR_ID ASC);

CREATE  INDEX I_FK_MESSAGE_UTILISATEUR1
     ON MESSAGE (UTILISATEUR_ID_1 ASC);
...
CREATE  INDEX I_FK_AMIS_UTILISATEUR1
...
ALTER TABLE MESSAGE 
  ADD FOREIGN KEY FK_MESSAGE_UTILISATEUR (UTILISATEUR_ID)
      REFERENCES UTILISATEUR (UTILISATEUR_ID) ;


ALTER TABLE MESSAGE 
  ADD FOREIGN KEY FK_MESSAGE_UTILISATEUR1 (UTILISATEUR_ID_1)
      REFERENCES UTILISATEUR (UTILISATEUR_ID) ;
...
ALTER TABLE AMIS 
  ADD FOREIGN KEY FK_AMIS_UTILISATEUR1 (UTILISATEUR_ID_1)
      REFERENCES UTILISATEUR (UTILISATEUR_ID) ;
